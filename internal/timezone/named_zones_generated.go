...
const (
	namedZoneMinID uint32 = 64898
	namedZoneMaxID uint32 = 65535
)

var namedZoneNames = [...]string{
	"GMT",                              // 65535
	"ACT",                              // 65534
	"AET",                              // 65533
	"AGT",                              // 65532
...
func namedZoneName(tzValue uint32) string {
	if tzValue < namedZoneMinID || tzValue > namedZoneMaxID {
		return ""
	}
	return namedZoneNames[namedZoneMaxID-tzValue]
}
